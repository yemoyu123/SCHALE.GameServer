...
namespace SCHALE.Common.Database {
    ...
    // Enums from FlatData (not importing whole namespace yet)
	...
	// Above enums and classes are ones references a lot in either dbs or protos, for the rest i just commented them out for now
