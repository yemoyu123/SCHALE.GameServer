...
public struct EliminateRaidRankingRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<SCHALE.Common.FlatData.EliminateRaidRankingRewardExcel> Pack(FlatBufferBuilder builder, EliminateRaidRankingRewardExcelT _o) {
    if (_o == null) return default(Offset<SCHALE.Common.FlatData.EliminateRaidRankingRewardExcel>);
