...
public struct EventContentFortuneGachaModifyExcelTable : IFlatbufferObject
{
  ...
  public SCHALE.Common.FlatData.EventContentFortuneGachaModifyExcel? DataList(int j) { int o = __p.__offset(4); return o != 0 ? (SCHALE.Common.FlatData.EventContentFortuneGachaModifyExcel?)(new SCHALE.Common.FlatData.EventContentFortuneGachaModifyExcel()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int DataListLength { get { int o = __p.__offset(4); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<SCHALE.Common.FlatData.EventContentFortuneGachaModifyExcelTable> CreateEventContentFortuneGachaModifyExcelTable(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateDataListVector(FlatBufferBuilder builder, Offset<SCHALE.Common.FlatData.EventContentFortuneGachaModifyExcel>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateDataListVectorBlock(FlatBufferBuilder builder, Offset<SCHALE.Common.FlatData.EventContentFortuneGachaModifyExcel>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateDataListVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<SCHALE.Common.FlatData.EventContentFortuneGachaModifyExcel>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateDataListVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<SCHALE.Common.FlatData.EventContentFortuneGachaModifyExcel>>(dataPtr, sizeInBytes); return builder.EndVector(); }
...
static public class EventContentFortuneGachaModifyExcelTableVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyVectorOfTables(tablePos, 4 /*DataList*/, SCHALE.Common.FlatData.EventContentFortuneGachaModifyExcelVerify.Verify, false)
