...
public struct EventContentLocationRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<SCHALE.Common.FlatData.EventContentLocationRewardExcel> Pack(FlatBufferBuilder builder, EventContentLocationRewardExcelT _o) {
    if (_o == null) return default(Offset<SCHALE.Common.FlatData.EventContentLocationRewardExcel>);
