...
public struct EventContentStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<SCHALE.Common.FlatData.EventContentStageRewardExcel> Pack(FlatBufferBuilder builder, EventContentStageRewardExcelT _o) {
    if (_o == null) return default(Offset<SCHALE.Common.FlatData.EventContentStageRewardExcel>);
