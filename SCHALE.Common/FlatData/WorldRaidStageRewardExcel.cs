...
public struct WorldRaidStageRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<SCHALE.Common.FlatData.WorldRaidStageRewardExcel> Pack(FlatBufferBuilder builder, WorldRaidStageRewardExcelT _o) {
    if (_o == null) return default(Offset<SCHALE.Common.FlatData.WorldRaidStageRewardExcel>);
