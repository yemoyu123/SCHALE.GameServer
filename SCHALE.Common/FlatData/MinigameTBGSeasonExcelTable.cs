...
public struct MinigameTBGSeasonExcelTable : IFlatbufferObject
{
  ...
  public void UnPackTo(MinigameTBGSeasonExcelTableT _o) {
    ...
    _o.DataList = new List<SCHALE.Common.FlatData.MinigameTBGSeasonExcelT>();
    for (var _j = 0; _j < this.DataListLength; ++_j) {_o.DataList.Add(this.DataList(_j).HasValue ? this.DataList(_j).Value.UnPack() : null);}
  }
  public static Offset<SCHALE.Common.FlatData.MinigameTBGSeasonExcelTable> Pack(FlatBufferBuilder builder, MinigameTBGSeasonExcelTableT _o) {
    if (_o == null) return default(Offset<SCHALE.Common.FlatData.MinigameTBGSeasonExcelTable>);
    var _DataList = default(VectorOffset);
    if (_o.DataList != null) {
      var __DataList = new Offset<SCHALE.Common.FlatData.MinigameTBGSeasonExcel>[_o.DataList.Count];
      for (var _j = 0; _j < __DataList.Length; ++_j) { __DataList[_j] = SCHALE.Common.FlatData.MinigameTBGSeasonExcel.Pack(builder, _o.DataList[_j]); }
...
{
  public List<SCHALE.Common.FlatData.MinigameTBGSeasonExcelT> DataList { get; set; }
