...
public struct ConquestRewardExcel : IFlatbufferObject
{
  ...
  public static Offset<SCHALE.Common.FlatData.ConquestRewardExcel> EndConquestRewardExcel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SCHALE.Common.FlatData.ConquestRewardExcel>(o);
  }
  ...
  public static Offset<SCHALE.Common.FlatData.ConquestRewardExcel> Pack(FlatBufferBuilder builder, ConquestRewardExcelT _o) {
    if (_o == null) return default(Offset<SCHALE.Common.FlatData.ConquestRewardExcel>);
